...
sql = """select * from original_canberra_coordinate"""
cursor.execute(sql)
...
for item in tqdm(result):
	...
	sql = """update original_canberra_coordinate set sa1_code = '""" + str(resultDict['sa1_maincode_2016']) + """', sa2_code = '""" + str(resultDict['sa2_maincode_2016']) + """', sa2_name = '""" + sa2Name + """, Canberra' where id = """ + str(item[0])
	# else:
